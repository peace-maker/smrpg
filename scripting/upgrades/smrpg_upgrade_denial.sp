...
public OnLibraryAdded(const String:name[])
{
	...
	{
		SMRPG_RegisterUpgradeType("Denial", UPGRADE_SHORTNAME, "Keep your weapons the next time your spawn after you've died.", 2, true, 2, 75, 50, SMRPG_BuySell, SMRPG_ActiveQuery);
